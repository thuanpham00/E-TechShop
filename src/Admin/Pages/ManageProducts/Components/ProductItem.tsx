...
export default function ProductItem({
  ...
  return (
    <div
      className="bg-white grid grid-cols-12 items-center gap-4 py-3 cursor-pointer border-t-0 border border-[#dedede] last:border-b-0 px-4 last:rounded-bl-md last:rounded-br-md"
      key={item._id}
    >
