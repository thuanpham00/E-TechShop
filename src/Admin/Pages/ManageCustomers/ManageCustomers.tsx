...
export default function ManageCustomers() {
  ...
  const columns: ColumnsType<UserType> = [
    ...
    },
    {
      ...
      render: (_: any, record: any) => (
        <div className="flex items-center gap-2">
          <img src={record.avatar || avatarDefault} alt={record.name} className="h-12 w-12 rounded-md object-cover" />
          <div>
    ...
    },
    {
      ...
      dataIndex: "email",
      key: "email",
      render: (email: string) => <div className="break-words">{email}</div>
    },
    {
      title: "Số điện thoại",
    ...
    },
    {
      ...
      render: (_: any, record: any) => (
        <div className="flex items-center justify-center gap-2">
          <button onClick={() => setAddItem(record)}>
          ...
          {addItem !== null && typeof addItem === "object" && (
            ...
            >
              ...
              >
                ...
                <form onSubmit={handleSubmitUpdate} className="bg-white dark:bg-darkPrimary rounded-xl min-w-[900px]">
