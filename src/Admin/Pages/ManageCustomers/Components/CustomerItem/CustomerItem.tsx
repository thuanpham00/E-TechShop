...
export default function CustomerItem({
  ...
  return (
    <div
      className="bg-white dark:bg-darkPrimary grid grid-cols-12 items-center gap-2 py-3 cursor-pointer border-t-0 border border-[#dedede] dark:border-darkBorder last:border-b-0 px-4 last:rounded-bl-md last:rounded-br-md"
      key={item._id}
    >
