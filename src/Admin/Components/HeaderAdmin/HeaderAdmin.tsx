...
export default function HeaderAdmin({ handleSidebar, isShowSidebar }: Props) {
  ...
  return (
    <header className="sticky top-0 left-0 z-10 bg-darkPrimary flex items-center justify-between p-3 border-b border-gray-200 dark:border-darkBorder">
      <Menu color={"white"} size={28} onClick={handleSideBarFunc} />
