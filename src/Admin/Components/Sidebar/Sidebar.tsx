        ...
        <div className="mt-4">
          {hasPermission(permissions.VIEW_DASHBOARD) && (
            <SidebarItem
              ...
              classNameWrapper={`${location.pathname.startsWith(sideBarList[0].path) ? "flex items-center gap-2 cursor-pointer mb-2 rounded-xl p-2 bg-gray-300 border border-gray-200 shadow-lg" : "flex items-center gap-2 cursor-pointer mb-2 rounded-sm p-2"}`}
          ...
          {hasPermission(permissions.VIEW_CUSTOMER) && (
            <SidebarItem
              ...
              classNameWrapper={`${location.pathname.startsWith(sideBarList[1].path) ? "flex items-center gap-2 cursor-pointer mb-2 rounded-xl p-2 bg-gray-300 border border-gray-200 shadow-lg" : "flex items-center gap-2 cursor-pointer mb-2 rounded-sm p-2"}`}
          ...
          {hasPermission(permissions.VIEW_EMPLOYEE) && (
            <SidebarItem
              ...
              classNameWrapper={`${location.pathname.startsWith(sideBarList[2].path) ? "flex items-center gap-2 cursor-pointer mb-2 rounded-xl p-2 bg-gray-300 border border-gray-200 shadow-lg" : "flex items-center gap-2 cursor-pointer mb-2 rounded-sm p-2"}`}
          ...
          {hasPermission(permissions.VIEW_CATEGORY) && (
            <SidebarItem
              ...
              classNameWrapper={`${location.pathname.startsWith(sideBarList[3].path) ? "flex items-center gap-2 cursor-pointer mb-2 rounded-xl p-2 bg-gray-300 border border-gray-200 shadow-lg" : "flex items-center gap-2 cursor-pointer mb-2 rounded-sm p-2"}`}
          ...
          {hasPermission(permissions.VIEW_PRODUCT) && (
            <SidebarItem
              ...
              classNameWrapper={`${location.pathname.startsWith(sideBarList[4].path) ? "flex items-center gap-2 cursor-pointer mb-2 rounded-xl p-2 bg-gray-300 border border-gray-200 shadow-lg" : "flex items-center gap-2 cursor-pointer mb-2 rounded-sm p-2"}`}
          ...
          {hasPermission(permissions.VIEW_ORDERS) && (
            <SidebarItem
              ...
              classNameWrapper={`${location.pathname.startsWith(sideBarList[5].path) ? "flex items-center gap-2 cursor-pointer mb-2 rounded-xl p-2 bg-gray-300 border border-gray-200 shadow-lg" : "flex items-center gap-2 cursor-pointer mb-2 rounded-sm p-2"}`}
          ...
          {hasPermission(permissions.VIEW_RECEIPT) && (
            <SidebarItem
              ...
              classNameWrapper={`${location.pathname.startsWith(sideBarList[6].path) ? "flex items-center gap-2 cursor-pointer mb-2 rounded-xl p-2 bg-gray-300 border border-gray-200 shadow-lg" : "flex items-center gap-2 cursor-pointer mb-2 rounded-sm p-2"}`}
          ...
          {hasPermission(permissions.VIEW_SUPPLIERS) && (
            <SidebarItem
              ...
              classNameWrapper={`${location.pathname.startsWith(sideBarList[7].path) ? "flex items-center gap-2 cursor-pointer mb-2 rounded-xl p-2 bg-gray-300 border border-gray-200 shadow-lg" : "flex items-center gap-2 cursor-pointer mb-2 rounded-sm p-2"}`}
          ...
          {hasPermission(permissions.VIEW_SUPPLIES) && (
            <SidebarItem
              ...
              classNameWrapper={`${location.pathname.startsWith(sideBarList[8].path) ? "flex items-center gap-2 cursor-pointer mb-2 rounded-xl p-2 bg-gray-300 border border-gray-200 shadow-lg" : "flex items-center gap-2 cursor-pointer mb-2 rounded-sm p-2"}`}
          ...
          {hasPermission(permissions.VIEW_ROLES) && (
            <SidebarItem
              ...
              classNameWrapper={`${location.pathname.startsWith(sideBarList[9].path) ? "flex items-center gap-2 cursor-pointer mb-2 rounded-xl p-2 bg-gray-300 border border-gray-200 shadow-lg" : "flex items-center gap-2 cursor-pointer mb-2 rounded-sm p-2"}`}
          ...
          {hasPermission(permissions.VIEW_REVENUE) && (
            <SidebarItem
              ...
              classNameWrapper={`${location.pathname.startsWith(sideBarList[10].path) ? "flex items-center gap-2 cursor-pointer mb-2 rounded-xl p-2 bg-gray-300 border border-gray-200 shadow-lg" : "flex items-center gap-2 cursor-pointer mb-2 rounded-sm p-2"}`}
